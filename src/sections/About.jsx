...
const About = () => {
    ...
    const handleCopy = () =>{
        navigator.clipboard.writeText('shubhamsenger4153@gmail.com');
        setHasCopied(true);
        ...
        <div className="xl:col-span-1 xl:row-span-2">
            <div className="grid-container">
                <img
                    ...
                    alt="grid-4"
                    className="w-full md:h-[126px] sm:h-[276px] h-fit sm:object-top"
                />
                <div className="space-y-2">
                    ...
                    <div className="copy-container" onClick={handleCopy}>
                        <img
                            ...
                            alt="copy"
                        />
                        <p className="md:text-xl font-medium text-gray_gradient text-white">shubhamsenger4153@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
